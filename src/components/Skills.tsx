          ...
          <div className="flex items-center gap-2.5 flex-wrap sm:flex-nowrap w-full sm:w-auto">
            ...
            <div className="relative flex items-center min-w-[180px] max-w-xs w-full sm:w-auto">
              ...
              <input
                ...
                className="w-full pl-8 pr-7 py-1 text-xs rounded-xl bg-slate-100/90 dark:bg-slate-900/90 border border-slate-200/80 dark:border-slate-800 text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-purple-500 transition-all shadow-2xs"
              />
              {searchQuery && (
                <button
                  type="button"
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "px-2.5 py-1 rounded-lg text-caption font-bold transition-all flex items-center gap-1 cursor-pointer whitespace-nowrap",
                      isActive
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-body font-medium">
                        {STRENGTHS_SKILLS.map((skill, idx) => {
                          ...
                          return (
                            <li 
                              key={idx} 
                              className="group/subcard relative p-2.5 rounded-xl skills-glass-card border-blue-200/60 dark:border-blue-500/30 space-y-1.5 transition-all hover:bg-white/95 dark:hover:bg-slate-800/95 shadow-2xs cursor-help"
                            >
                              {/* Hover Tooltip */}
                              ...
                              <div className="flex items-center justify-between text-body">
                                ...
                                <span className="px-1.5 py-0.5 rounded bg-blue-500/15 dark:bg-blue-500/25 text-blue-800 dark:text-blue-300 font-mono font-black text-xs shrink-0 ml-2 tabular-nums">
                                  {skill.percent}%
                                </span>
                              </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-body font-medium">
                        {OPPORTUNITIES_SKILLS.map((opp, idx) => {
                          ...
                          return (
                            <div 
                              key={idx} 
                              className="group/subcard relative p-2.5 rounded-xl skills-glass-card border-purple-200/60 dark:border-purple-500/20 space-y-1.5 transition-all hover:bg-white/95 dark:hover:bg-slate-800/95 shadow-2xs cursor-help"
                            >
                              <div className="absolute bottom-[calc(100%+8px)] left-1/2 -translate-x-1/2 pointer-events-none opacity-0 group-hover/subcard:opacity-100 group-hover/subcard:translate-y-0 translate-y-1 transition-all duration-200 z-50 w-60 sm:w-64 p-2.5 rounded-xl bg-slate-900/95 dark:bg-slate-950/95 text-white shadow-2xl border border-white/20 backdrop-blur-md text-left">
                              ...
                              <div className="flex items-center justify-between text-body">
                                ...
                                <span className="px-1.5 py-0.5 rounded bg-purple-500/15 dark:bg-purple-500/25 text-purple-800 dark:text-purple-300 font-mono font-black text-xs shrink-0 ml-2 tabular-nums">
                                  {opp.meter}%
                                </span>
                              </div>
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-body font-medium">
                        {WEAKNESSES_SKILLS.map((skill, idx) => {
                          ...
                          return (
                            <li 
                              key={idx} 
                              className="group/subcard relative p-2.5 rounded-xl skills-glass-card border-amber-200/60 dark:border-amber-500/30 space-y-1.5 transition-all hover:bg-white/95 dark:hover:bg-slate-800/95 shadow-2xs cursor-help"
                            >
                              <div className="absolute bottom-[calc(100%+8px)] left-1/2 -translate-x-1/2 pointer-events-none opacity-0 group-hover/subcard:opacity-100 group-hover/subcard:translate-y-0 translate-y-1 transition-all duration-200 z-50 w-60 sm:w-64 p-2.5 rounded-xl bg-slate-900/95 dark:bg-slate-950/95 text-white shadow-2xl border border-white/20 backdrop-blur-md text-left">
                              ...
                              <div className="flex items-center justify-between text-body">
                                ...
                                <span className="px-1.5 py-0.5 rounded bg-amber-500/15 dark:bg-amber-500/25 text-amber-800 dark:text-amber-300 font-mono font-black text-xs shrink-0 ml-2 tabular-nums">
                                  {skill.percent}%
                                </span>
                              </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-body font-medium">
                        {THREATS_SKILLS.map((threat, idx) => {
                          ...
                          return (
                            <div 
                              key={idx} 
                              className="group/subcard relative p-2.5 rounded-xl skills-glass-card border-rose-200/60 dark:border-rose-500/20 space-y-1.5 transition-all hover:bg-white/95 dark:hover:bg-slate-800/95 shadow-2xs cursor-help"
                            >
                              <div className="absolute bottom-[calc(100%+8px)] left-1/2 -translate-x-1/2 pointer-events-none opacity-0 group-hover/subcard:opacity-100 group-hover/subcard:translate-y-0 translate-y-1 transition-all duration-200 z-50 w-60 sm:w-64 p-2.5 rounded-xl bg-slate-900/95 dark:bg-slate-950/95 text-white shadow-2xl border border-white/20 backdrop-blur-md text-left">
                              ...
                              <div className="flex items-center justify-between text-body">
                                ...
                                <span className="px-1.5 py-0.5 rounded bg-rose-500/15 dark:bg-rose-500/25 text-rose-800 dark:text-rose-300 font-mono font-black text-xs shrink-0 ml-2 tabular-nums">
                                  {threat.meter}%
                                </span>
                              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {filteredSkillGroups.map((group) => {
                return (
                  <div
                    key={group.id}
                    className="p-4 sm:p-5 rounded-2xl skills-glass-card border border-slate-200/80 dark:border-slate-800/80 space-y-3.5 shadow-sm hover:shadow-md transition-all"
                  >
                    {/* Domain Card Header */}
                    <div className="flex items-start justify-between gap-3 pb-2.5 border-b border-slate-200/60 dark:border-slate-800/60">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="px-2 py-0.5 rounded-md font-mono text-xs font-black bg-purple-500/15 text-purple-700 dark:text-purple-300">
                            {group.code}
                          </span>
                    ...
                    <div className="space-y-2.5">
                      {group.skills.map((skill) => {
                        ...
                        return (
                          <div
                            key={skill.id}
                            className="p-2.5 rounded-xl bg-slate-50/70 dark:bg-slate-900/50 border border-slate-200/50 dark:border-slate-800/50 space-y-1.5"
                          >
                            <div className="flex items-center justify-between text-body">
                              <span className="flex items-center gap-2 font-bold text-slate-900 dark:text-slate-100 min-w-0">
                                <IconComponent className="w-4 h-4 text-purple-600 dark:text-purple-400 shrink-0" />
                              ...
                              <div className="flex items-center gap-2 shrink-0">
                                ...
                                <span className="px-1.5 py-0.5 rounded bg-purple-500/15 text-purple-700 dark:text-purple-300 font-mono font-bold text-xs tabular-nums">
                                  {skill.percentage}%
                                </span>
                              </div>
                            </div>
                            ...
                            {skill.tools && skill.tools.length > 0 && (
                              <div className="flex items-center flex-wrap gap-1 pt-1">
                                {skill.tools.map((tool, tIdx) => (
                                  <span
                                    key={tIdx}
                                    className="px-1.5 py-0.5 rounded text-3xs font-semibold bg-slate-200/60 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300"
                                  >
                                    {tool}
                                  </span>
                                ))}
                            ...
                            {/* Meter Bar */}
                            <div className="w-full h-1 bg-slate-200/70 dark:bg-slate-800 rounded-full overflow-hidden mt-1">
                              <div
