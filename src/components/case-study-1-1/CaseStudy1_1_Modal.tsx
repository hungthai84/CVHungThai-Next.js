...
export function CaseStudy1_1_Modal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/65 backdrop-blur-md z-50 flex items-center justify-center animate-in fade-in duration-300">
      <div className="glass-base bg-white/90 dark:bg-slate-900/90 rounded-3xl max-w-md w-full shadow-2xl relative m-4 max-h-[90vh] overflow-y-auto border border-white/80 dark:border-slate-700 animate-in zoom-in-95 duration-300">
