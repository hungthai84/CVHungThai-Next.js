            ...
            <div id="tuvi-philosophy-cards" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 w-full">
              {ACTION_PHILOSOPHY_CARDS.map((card) => {
                ...
                return (
                  <div 
                    key={card.id}
                    className="rounded-2xl p-4 sm:p-5 bg-white/95 dark:bg-slate-900/90 border border-amber-200/80 dark:border-amber-500/30 shadow-2xs hover:shadow-md transition-all duration-300 flex flex-col justify-start text-left gap-2.5 backdrop-blur-md"
                  >
