...
export async function askAI(
  ...
  if (!trimmed) {
    return {
      answer: 'Xin chào! Tôi là Trí Nhân trợ lý của anh Nguyễn Hùng Thái. Bạn có thể chọn các câu hỏi mẫu gợi ý hoặc nhập câu hỏi trực tiếp để tìm hiểu về anh Thái.',
      source: 'knowledge',
      confidence: 1,
      category: 'GENERAL',
      canSpeak: true,
      suggestions: ['Anh Thái là ai?', 'Bao nhiêu năm kinh nghiệm?', 'Các kỹ năng chính', 'Dự án tiêu biểu'],
      actions: []
    };
  }
  ...
  const fallbackResult: AIResponse = {
    answer: 'Trí Nhân trợ lý xin phép được thông tin: Câu hỏi này hiện chưa có trong cơ sở dữ liệu chi tiết của anh Nguyễn Hùng Thái. Bạn có thể chọn danh sách 47 câu hỏi mẫu gợi ý hoặc liên hệ trực tiếp với anh Thái.',
    source: 'fallback',
    confidence: 0.4,
    category: 'UNKNOWN',
    canSpeak: true,
    suggestions: [
      ...
      'Kỹ năng quản lý Call Center & CX',
      'Liên hệ trực tiếp'
    ],
    actions: [{ type: 'contact', label: 'Liên hệ với anh Nguyễn Hùng Thái' }]
  };
