...
export const PROJECTS_LIST: ProjectCard[] = [
  // [Dự án 1] 1.1 · Xây dựng và vận hành Phòng Dịch vụ Khách hàng
  {
    ...
    caseStudy: {
      solutionSummary: "Chuyển đổi phòng chăm sóc khách hàng từ một trung tâm chi phí thụ động (Cost Center) thành bệ phóng trải nghiệm và trung tâm giá trị (Value Center). Thiết lập bộ máy vận hành hoàn chỉnh từ Tầm nhìn, Sơ đồ tổ chức 6 khối chuyên trách, Luồng xử lý 3 tuyến, Khung năng lực tuyển dụng đến Văn hóa Customer-Centric.",
      context: "Doanh nghiệp chưa có bộ máy chăm sóc khách hàng chuyên trách bài bản, các phản hồi của khách hàng bị đùn đẩy và phản hồi chậm trễ, dẫn đến tỷ lệ rời bỏ cao.",
      actions: [
        {
          title: "01 · TẦM NHÌN & SỨ MỆNH",
          desc: "Định hình rõ vai trò và đóng góp chiến lược của phòng chăm sóc khách hàng trong bức tranh chung của doanh nghiệp.",
  ...
  // [Dự án 2] 1.2 · Thiết lập mục tiêu và chỉ tiêu hoạt động
  {
    ...
    caseStudy: {
      solutionSummary: "Chuyển đổi Phòng Chăm sóc Khách hàng từ trung tâm chi phí (Cost Center) thành trung tâm giá trị (Value Center) thông qua việc kết hợp hệ thống đo lường hiệu suất KPI vận hành với mục tiêu tham vọng OKR gắn liền với chiến lược tăng trưởng toàn công ty.",
      context: "Phòng Chăm sóc Khách hàng hoạt động thiếu mục tiêu định lượng cụ thể, chủ yếu xử lý thụ động theo sự việc phát sinh và báo cáo định kỳ bằng file thủ công.",
      actions: [
        {
  ...
  // [Dự án 3] 1.3 · Nâng cao chất lượng trải nghiệm khách hàng
  {
    ...
    timeframe: "2013 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / Head of CX",
    ...
    caseStudy: {
      ...
      context: "chăm sóc khách hàng chủ yếu tập trung giải quyết sự cố đơn lẻ theo từng ticket, thiếu cái nhìn toàn diện về hành trình cảm xúc và các điểm chạm xuyên suốt vòng đời khách hàng.",
      actions: [
        {
  ...
  // [Dự án 4] 1.4 · Quản lý và triển khai dự án chăm sóc khách hàng
  {
    ...
    timeframe: "2013 – 2021",
    role: "Trưởng phòng Chăm sóc Khách hàng / Project Lead",
    tags: ["#PhátTriển", "#ProjectManagement", "#AgileKanban"],
    image: "https://i.ibb.co/0RtGZR9b/1-4-Qu-n-l-d-n-chăm sóc khách hàng.png",
    mindmapImage: "https://i.ibb.co/4ZtQD8gK/1-4-Qu-n-l-d-n-chăm sóc khách hàng.png",
    caseStudy: {
      ...
      context: "Phòng Chăm sóc Khách hàng có rất nhiều sáng kiến cải tiến nhưng thường bị chậm tiến độ, thiếu nguồn lực chuyên trách và khó phối hợp với các đội ngũ Công nghệ / Sản phẩm.",
      actions: [
        {
  ...
  // [Dự án 5] 1.5 · Cải tiến sản phẩm từ ý kiến khách hàng
  {
    ...
    timeframe: "2011 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / Voice of Customer Lead",
    ...
    caseStudy: {
      solutionSummary: "Thiết lập Vòng lặp Phản hồi Tiếng nói Khách hàng khép kín (Closed-Loop Voice of Customer - VoC), chuyển hóa hàng triệu phản ánh, thắc mắc và đóng góp từ tiền tuyến chăm sóc khách hàng thành nguồn dữ liệu định lượng có giá trị cao nhất, thúc đẩy đội ngũ Product/Tech liên tục hoàn thiện sản phẩm.",
      context: "chăm sóc khách hàng tiếp nhận hàng ngàn ý kiến phản hồi mỗi ngày nhưng thông tin bị trôi dạt trong các báo cáo định kỳ, Product Team không có dữ liệu cụ thể để ưu tiên sửa lỗi hoặc phát triển tính năng mới.",
      actions: [
        {
  ...
  // [Dự án 6] 1.6 · Quản lý khủng hoảng và giảm khách hàng rời bỏ
  {
    ...
    timeframe: "2013 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / Crisis Management Lead",
  ...
  // [Dự án 7] 2.1 · Chuẩn hóa quy trình chăm sóc khách hàng
  {
    ...
    timeframe: "2011 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / Process Architecture Lead",
    tags: ["#VậnHành", "#SOP", "#WorkflowStandard"],
    image: "https://i.ibb.co/SDRxyVYm/2-1-Chu-n-h-a-quy-tr-nh-chăm sóc khách hàng.png",
    mindmapImage: "https://i.ibb.co/F4TQSP1H/2-1-Chu-n-h-a-quy-tr-nh-chăm sóc khách hàng.png",
    caseStudy: {
  ...
  // [Dự án 8] 2.2 · Tối ưu hóa các kênh hỗ trợ khách hàng
  {
    ...
    timeframe: "2007 – 2024",
    role: "Trưởng Nhóm / Trưởng phòng Chăm sóc Khách hàng",
  ...
  // [Dự án 9] 2.3 · Tự động hóa quy trình chăm sóc khách hàng
  {
    ...
    timeframe: "2016 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / Automation Lead",
  ...
  // [Dự án 10] 2.4 · Quản lý hoạt động chăm sóc khách hàng chủ động
  {
    ...
    timeframe: "2011 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / Outbound Lead",
    ...
    caseStudy: {
      ...
      context: "Phòng Chăm sóc Khách hàng chỉ hoạt động khi có sự cố phát sinh từ phía người dùng, dẫn đến hình ảnh thương hiệu trong mắt khách hàng chỉ gắn liền với phiền phức và lỗi dịch vụ.",
      actions: [
        {
  ...
  // [Dự án 11] 2.5 · Quản lý đối tác thuê ngoài chăm sóc khách hàng
  {
    ...
    timeframe: "2018 – 2021",
    role: "Trưởng phòng Chăm sóc Khách hàng / BPO Manager",
  ...
  // [Dự án 12] 3.1 · Xây dựng hệ thống quản lý thông tin khách hàng
  {
    ...
    timeframe: "2013 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / CRM System Architect",
  ...
  // [Dự án 13] 3.2 · Phân tích và báo cáo dữ liệu khách hàng
  {
    ...
    timeframe: "2011 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / CX Analytics Lead",
    ...
    caseStudy: {
      ...
      context: "Báo cáo hoạt động phòng chăm sóc khách hàng được tổng hợp thủ công vào cuối tuần hoặc cuối tháng trên các file Excel nặng nề, thiếu tính chính xác và không thể hiện được xu hướng thời gian thực.",
      actions: [
        {
  ...
  // [Dự án 15] 3.4 · Xây dựng trợ lý ảo chăm sóc khách hàng
  {
    ...
    timeframe: "2023 – 2026+",
    role: "Trưởng phòng Chăm sóc Khách hàng / AI Chatbot Project Lead",
  ...
  // [Dự án 16] 4.1 · Phát triển chương trình đào tạo trực tuyến
  {
    ...
    timeframe: "2013 – 2024",
    role: "Trưởng phòng Chăm sóc Khách hàng / E-Learning Director",
  ...
  // [Dự án 17] 4.2 · Xây dựng khung năng lực và lộ trình phát triển
  {
    ...
    timeframe: "2003 – 2026+",
    role: "Trưởng Nhóm / Trưởng phòng Chăm sóc Khách hàng (Talent Lead)",
    ...
    caseStudy: {
      ...
      context: "Nghề chăm sóc khách hàng thường bị xem là công việc tạm bợ, thiếu lộ trình thăng tiến rõ ràng, tiêu chí xét tăng lương/thăng chức mang tính cảm tính của người quản lý.",
      actions: [
        {
  ...
  // [Dự án 18] 5.1 · Thành lập và vận hành Trung tâm Hỗ trợ Khách hàng
  {
    ...
    timeframe: "2013 – 2021",
    role: "Trưởng phòng Chăm sóc Khách hàng / Helpdesk Operations Director",
  ...
  // [Dự án 20] 6.2 · Quản trị sự thay đổi và khủng hoảng dịch vụ
  {
    ...
    caseStudy: {
      ...
      context: "Khi hệ thống kỹ thuật gặp sự cố sập server, nghẽn cổng thanh toán hoặc giao hàng đình trệ diện rộng, phòng chăm sóc khách hàng rơi vào thế bị động, tổng đài quá tải cháy máy, nhân viên không biết giải thích thế nào khiến khách hàng phẫn nộ tràn lên mạng xã hội tẩy chay.",
      actions: [
        {
          title: "01 · Early Warning & Incident War Room",
          desc: "Hội quân khẩn cấp giữa Lãnh đạo Chăm sóc Khách hàng, Kỹ thuật, PR và Pháp chế.",
  ...
  // [Dự án 21] 6.3 · Ứng dụng trí tuệ nhân tạo nâng cao hiệu suất chăm sóc khách hàng
  {
    id: "p6_3",
    groupId: "g6",
    groupTitle: "Nhóm 06 · Phân tích & Cải tiến",
    ...
    phase: "Xuyên suốt",
    phaseCode: "6.3",
    branchTitle: "6.3 · Ứng dụng trí tuệ nhân tạo nâng cao hiệu suất chăm sóc khách hàng",
    ...
    image: "https://i.ibb.co/4gf9BC3S/6-3-ng-d-ng-tr-tu-nh-n-t-o-n-ng-cao-hi-u-su-t-chăm sóc khách hàng.png",
    mindmapImage: "https://i.ibb.co/wFZ1qXFt/6-3-ng-d-ng-tr-tu-nh-n-t-o-n-ng-cao-hi-u-su-t-chăm sóc khách hàng.png",
    caseStudy: {
      ...
      context: "Nhân viên chăm sóc khách hàng phải chịu áp lực ghi nhớ hàng ngàn trang tài liệu, vừa nghe khách nói vừa gõ máy tính ghi chép tóm tắt sau cuộc gọi (After-Call Work) mất rất nhiều thời gian. Trong khi đó, đội QA chỉ có thể nghe và chấm điểm thủ công được 1-2% tổng số cuộc gọi.",
      actions: [
        {
