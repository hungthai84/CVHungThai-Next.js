        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch w-full">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div 
              ...
              className="glass-surface backdrop-blur-2xl bg-white/90 dark:bg-slate-900/85 border border-slate-200/80 dark:border-slate-800/80 p-4 sm:p-5 shadow-md flex flex-col justify-between gap-3 text-left relative overflow-hidden"
            >
              <div className="flex items-center justify-between pb-2 border-b border-slate-200/80 dark:border-slate-800/80">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black tracking-wider uppercase bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/60">
                  CX Manager
                </span>
              </div>

              {/* Profile Overview */}
              <div className="py-2.5 px-3.5 rounded-xl bg-slate-100/80 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/60 flex items-center justify-between gap-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1">
                {/* Phone / Zalo */}
                <div className="p-2.5 rounded-xl bg-emerald-50/80 dark:bg-emerald-950/30 border border-emerald-200/80 dark:border-emerald-800/50 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 text-slate-700 dark:text-slate-200 border border-emerald-200 dark:border-emerald-800 transition-all cursor-pointer shadow-xs"
                ...
                {/* Email */}
                <div className="p-2.5 rounded-xl bg-blue-50/80 dark:bg-blue-950/30 border border-blue-200/80 dark:border-blue-800/50 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-blue-100 dark:hover:bg-blue-900/50 text-slate-700 dark:text-slate-200 border border-blue-200 dark:border-blue-800 transition-all cursor-pointer shadow-xs"
                ...
                {/* Website */}
                <div className="p-2.5 rounded-xl bg-cyan-50/80 dark:bg-cyan-950/30 border border-cyan-200/80 dark:border-cyan-800/50 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-cyan-100 dark:hover:bg-cyan-900/50 text-slate-700 dark:text-slate-200 border border-cyan-200 dark:border-cyan-800 transition-all cursor-pointer shadow-xs"
                    title={isVi ? "Sao chép" : "Copy"}
                  >
                ...
                {/* LinkedIn */}
                <div className="p-2.5 rounded-xl bg-sky-50/80 dark:bg-sky-950/30 border border-sky-200/80 dark:border-sky-800/50 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-white dark:bg-slate-900 hover:bg-sky-100 dark:hover:bg-sky-900/50 text-slate-700 dark:text-slate-200 border border-sky-200 dark:border-sky-800 transition-all cursor-pointer shadow-xs"
                    title={isVi ? "Sao chép" : "Copy"}
                  >
            ...
            <div 
              ...
              style={{ borderRadius: "var(--theme-radius-card, var(--theme-radius, 16px))" }}
              className="glass-surface backdrop-blur-2xl bg-white/90 dark:bg-slate-900/85 border border-slate-200/80 dark:border-teal-400/30 p-4 shadow-md flex flex-col justify-between gap-3 text-left"
            >
              <div className="flex items-center justify-between pb-2 border-b border-teal-200/60 dark:border-teal-800/60">
                ...
                <span className="text-[10px] font-black px-2 py-0.5 rounded-full bg-teal-50 dark:bg-teal-950/60 text-teal-700 dark:text-teal-300 border border-teal-200/60">
                  Official Zalo
                </span>
              </div>

              <div className="bg-slate-50 dark:bg-slate-950/80 p-2.5 rounded-xl border border-slate-200/80 dark:border-slate-800/80 flex items-center justify-center gap-3.5 shadow-inner">
                <div className="w-20 h-20 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 bg-white p-1 shadow-xs shrink-0">
                  <img 
                    src={qrCodeUrl} 
              ...
              <div className="grid grid-cols-2 gap-2 pt-0.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="py-1.5 px-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs flex items-center justify-center gap-1.5 shadow-xs transition-all active:scale-95 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="py-1.5 px-3 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-extrabold text-xs border border-slate-200 dark:border-slate-700 flex items-center justify-center gap-1.5 transition-all active:scale-95 cursor-pointer"
                >
                  {copiedZaloLink ? (
                    <>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="p-2.5 rounded-xl bg-white/90 dark:bg-slate-900/80 border border-slate-200/80 dark:border-emerald-400/30 shadow-2xs flex flex-col justify-between">
              ...
              <div className="p-2.5 rounded-xl bg-white/90 dark:bg-slate-900/80 border border-slate-200/80 dark:border-blue-400/30 shadow-2xs flex flex-col justify-between">
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div 
              ...
              style={{ borderRadius: "var(--theme-radius-card, var(--theme-radius, 16px))" }}
              className="glass-surface backdrop-blur-2xl bg-white/95 dark:bg-slate-900/90 border border-slate-200/80 dark:border-blue-500/30 p-5 sm:p-6 shadow-md hover:shadow-xl transition-all duration-300 flex flex-col justify-between gap-4 text-left h-full"
            >
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-200/80 dark:border-slate-800/80">
                ...
                <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-caption font-bold text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/60 border border-blue-200/80 dark:border-blue-800/80">
                  ...
                  {quickTopics.map((topic) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-2 rounded-xl text-2xs font-bold text-left transition-all border cursor-pointer flex flex-col justify-between gap-1 ${
                          isSelected
                            ? "bg-blue-600 text-white border-blue-600 shadow-xs scale-102"
                            : "bg-slate-100/80 dark:bg-slate-800/70 text-slate-700 dark:text-slate-300 border-slate-200/70 dark:border-slate-700/70 hover:bg-blue-50 dark:hover:bg-blue-950/40 hover:text-blue-600"
                        }`}
                      >
              ...
              <form onSubmit={handleSendEmail} className="space-y-3 flex-1 flex flex-col justify-between">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1 text-left">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 text-xs bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-blue-500/50 transition-all"
                    />
                  </div>
                ...
                <div className="space-y-1 text-left">
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 text-xs bg-white dark:bg-slate-950/80 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-blue-500/50 transition-all resize-none"
                  />
                </div>
                ...
                {/* Form Success Banner */}
                {formSuccess && (
                  <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-300 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 text-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-2xs cursor-pointer shadow-xs"
                      >
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-2xs cursor-pointer"
                      >
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                  <div className="flex items-center gap-2">
                    <button
                      type="submit"
                      className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-black text-xs sm:text-sm flex items-center gap-2 shadow-md hover:shadow-lg transition-all active:scale-95 cursor-pointer"
                    >
                    ...
                    <button
                      type="button"
                      onClick={handleCopyEmailContent}
                      className="px-3.5 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs border border-slate-200 dark:border-slate-700 transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
