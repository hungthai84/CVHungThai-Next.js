...
export const SECTION_EXTRA_DETAILS: Record<string, SectionExtraDetail> = {
  letter: {
    tagVi: "Thông điệp lãnh đạo & Cam kết",
    tagEn: "Executive Message & Commitment",
    shortcut: "L",
    descriptionVi: "Thư ngỏ từ Trưởng phòng CSKH Nguyễn Hùng Thái - Chia sẻ về tầm nhìn quản trị, triết lý phục vụ khách hàng, giá trị cốt lõi và lời mời hợp tác chiến lược.",
    descriptionEn: "Executive letter from CS Leader Nguyen Hung Thai - Sharing strategic management vision, customer service philosophy, core values, and partnership invitation.",
    highlightsVi: [
      "Thông điệp gửi tới Quý Lãnh đạo, Đối tác và Khách hàng",
      "Triết lý quản trị lấy con người và công nghệ làm trọng tâm",
      "Cam kết kiến tạo trải nghiệm khách hàng vượt trội và bền vững",
    ],
    highlightsEn: [
      "Executive message to Leadership, Partners, and Valued Clients",
      "Human-centric & tech-driven management philosophy",
      "Commitment to crafting sustainable & world-class customer experiences",
    ],
  },
  memories: {
    tagVi: "Khoảnh khắc & Cột mốc 22+ năm",
    tagEn: "22+ Years Milestones & Gallery",
    shortcut: "M",
    descriptionVi: "Thư viện hình ảnh và câu chuyện kỷ niệm lưu dấu những khoảnh khắc đáng nhớ trong sự nghiệp, các giải thưởng uy tín, sự kiện đào tạo và văn hóa đội ngũ.",
    descriptionEn: "Curated photo gallery and memory highlights capturing pivotal career moments, prestigious awards, training keynotes, and team culture.",
    highlightsVi: [
      "Khoảnh khắc vinh danh giải thưởng & Thành tựu sự nghiệp",
      "Sự kiện đào tạo, hội thảo chuyên môn & Hoạt động đội ngũ",
      "Ghi dấu 22+ năm hành trình gắn kết và cống hiến",
    ],
    highlightsEn: [
      "Award ceremonies & career achievement highlights",
      "Corporate training keynotes, workshops & team building events",
      "Capturing 22+ years of dedication, growth & executive journey",
    ],
  },
  home: {
