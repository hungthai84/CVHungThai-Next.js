...
const PRESENTATION_SLIDES = [
  ...
  {
    id: "systems",
    titleVi: "12. Sơ đồ Kiến trúc & Hệ thống",
    titleEn: "12. Architecture & Systems Blueprint",
    descVi: "Sơ đồ kiến trúc tổng thể, hạ tầng dữ liệu và công nghệ áp dụng vào tối ưu hóa vận hành.",
    descEn: "Overall architecture blueprint, data infrastructure, and technologies for operational optimization.",
    highlightVi: "Bảo mật • Khả năng Mở rộng • Tích hợp AI",
    highlightEn: "Security • Scalability • AI Integration",
    gradient: "from-sky-600 via-blue-600 to-indigo-600",
  },
  {
    id: "contact",
    titleVi: "13. Thông tin Liên hệ & Kết nối",
