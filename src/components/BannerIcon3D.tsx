...
export function BannerIcon3D({ iconType, className = "w-10 h-10", size = 48 }: BannerIcon3DProps) {
  ...
  switch (normalizedType) {
    // 1. Sổ kiểm tra / Sách ký séc (Checkbook)
    case "letter":
    case "openletter":
      return (
        <svg width={size} height={size} viewBox="0 0 64 64" fill="none" className={className}>
          {/* Checkbook Cover */}
          <rect x="8" y="12" width="44" height="40" rx="8" fill="url(#checkbook_cover)" />
          {/* Spine of the checkbook */}
          <path d="M8 12C8 12 11 15 11 20V44C11 49 8 52 8 52" stroke="rgba(255,255,255,0.4)" strokeWidth="3" strokeLinecap="round" />
          {/* Inner pages peaking out from the right side */}
          <path d="M52 16H48V48H52C53.1 48 54 47.1 54 46V18C54 16.9 53.1 16 52 16Z" fill="url(#checkbook_pages)" />
          {/* Gold Embossed Badge or Pattern on cover */}
          <rect x="18" y="22" width="24" height="20" rx="4" fill="url(#checkbook_gold_badge)" stroke="#FEF08A" strokeWidth="1" />
          {/* Elegant Check icon on the badge */}
          <path d="M24 32L28 36L36 28" stroke="#15803D" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
          
          <defs>
            <linearGradient id="checkbook_cover" x1="8" y1="12" x2="52" y2="52" gradientUnits="userSpaceOnUse">
              <stop stopColor="#1E3A8A" />
              <stop offset="1" stopColor="#0F172A" />
            </linearGradient>
            <linearGradient id="checkbook_pages" x1="48" y1="16" x2="54" y2="48" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FFFFFF" />
              <stop offset="1" stopColor="#E2E8F0" />
            </linearGradient>
            <linearGradient id="checkbook_gold_badge" x1="18" y1="22" x2="42" y2="42" gradientUnits="userSpaceOnUse">
    ...
    // Dịch vụ (Services / Diamond Gear & Sparkles)
    case "services":
    case "service":
    case "consulting":
    case "solutions":
      return (
        <svg width={size} height={size} viewBox="0 0 64 64" fill="none" className={className}>
          {/* Ambient Glow */}
          <circle cx="32" cy="32" r="24" fill="url(#serv_glow)" opacity="0.4" />
          {/* Central Layered Diamond / Cube */}
          <path d="M32 10L52 22V42L32 54L12 42V22L32 10Z" fill="url(#serv_body)" stroke="#6366F1" strokeWidth="1.5" />
          {/* Top Facet */}
          <path d="M32 10L52 22L32 34L12 22L32 10Z" fill="url(#serv_top)" />
          {/* Left Facet */}
          <path d="M12 22L32 34V54L12 42V22Z" fill="url(#serv_left)" />
          {/* Right Facet */}
          <path d="M32 34L52 22V42L32 54V34Z" fill="url(#serv_right)" />
          {/* Core Headset / Sparkle in Center */}
          <circle cx="32" cy="28" r="5" fill="#FFFFFF" />
          <path d="M26 34C26 30.6863 28.6863 28 32 28C35.3137 28 38 30.6863 38 34V38H26V34Z" fill="#FBBF24" />
          {/* Floating Orbiting Stars */}
          <circle cx="48" cy="16" r="3" fill="#38BDF8" />
          <circle cx="16" cy="46" r="3" fill="#F43F5E" />

          <defs>
            <radialGradient id="serv_glow" cx="32" cy="32" r="24" gradientUnits="userSpaceOnUse">
              <stop stopColor="#6366F1" />
              <stop offset="1" stopColor="#6366F1" stopOpacity="0" />
            </radialGradient>
            <linearGradient id="serv_body" x1="12" y1="10" x2="52" y2="54" gradientUnits="userSpaceOnUse">
              <stop stopColor="#4F46E5" />
              <stop offset="1" stopColor="#1E1B4B" />
            </linearGradient>
            <linearGradient id="serv_top" x1="12" y1="10" x2="52" y2="34" gradientUnits="userSpaceOnUse">
              <stop stopColor="#818CF8" />
              <stop offset="1" stopColor="#6366F1" />
            </linearGradient>
            <linearGradient id="serv_left" x1="12" y1="22" x2="32" y2="54" gradientUnits="userSpaceOnUse">
              <stop stopColor="#4338CA" />
              <stop offset="1" stopColor="#312E81" />
            </linearGradient>
            <linearGradient id="serv_right" x1="32" y1="22" x2="52" y2="54" gradientUnits="userSpaceOnUse">
    ...
    case "gallery":
      return (
        <svg width={size} height={size} viewBox="0 0 64 64" fill="none" className={className}>
          ...
          {/* Front Photo Card */}
          <rect x="16" y="16" width="40" height="34" rx="6" fill="#FFFFFF" style={{ filter: "drop-shadow(0px 4px 12px rgba(0,0,0,0.2))" }} />
